                    ...
                    <div class="flex">
                        <div class="relative w-full">
                            <input v-model="searchText" type="search" id="search-dropdown"
                                   ...
                                   class="block p-2.5 w-full z-20 text-sm text-wite rounded rounded-e-lg border focus:ring-blue-500 focus:border-blue-500 bg-gray-700 border-slate-200 placeholder-gray-400"/>
                            <button type="submit"
