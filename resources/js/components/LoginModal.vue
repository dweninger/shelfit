...
<popup-modal title="Login" :isVisible="isVisible" @close="onCloseModal">
    <div class="p-4 md:p-5">
        <form @submit.prevent="submitForm" class="space-y-4">
            <form-input v-model="email" type="email" field="email" label="Your email" placeholder="jdoe@example.com" required/>
            <form-input v-model="password" type="password" field="password" label="Your password" placeholder="••••••••" required/>
            <button
                type="submit"
